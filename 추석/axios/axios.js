...
// 3. .gitignore 파일을 생성하고 node_modules 작성
...
// 문제. 아래 요구사항을 해결하는 함수를 작성하고 함수를 실행한다.
// 함수이름 : getSearchPosts
// 요구사항 : 게시글 검색 목록 조회(Search posts) API를 호출해서 검색어가 "phone"인 게시글 목록의 응답 객체를 출력한다
// async function getSearchPosts() {
//   const res = await axios.get(`${BASE_URL}/posts/search?q=phone`);
//   const data = res["data"];
//   console.log(data);
// }
// getSearchPosts();
...
// 요구사항 : 게시글 검색 목록 조회(Search posts) API를 호출해서 검색어가 "phone"인 게시글 목록의 응답 객체의 속성 중 posts 배열을 출력한다
...
//   const res = await axios.get(`${BASE_URL}/posts/user/70`);
//   const data = res["data"];
//   console.log(data);
// }
// getPostsByUserId();
